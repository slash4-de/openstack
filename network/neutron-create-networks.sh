...
--allocation-pool start=192.168.30.100,end=192.168.30.200 --disable-dhcp --gateway 192.168.30.1 192.168.30.0/24

neutron net-create admin-net

neutron subnet-create admin-net --name admin-subnet --dns-nameserver 8.8.4.4 --gateway 10.0.1.1 10.0.1.0/24

#!/bin/bash
### SCRIPT NAME : Compute_Setup_IP.sh
### Author 	: Imran Ahmed <researcher6@live.com>
### Date	: 	15-JULY-2015
### Description	: This script configures the IP addresses on all interfaces of the COMPUTE Node.
...
echo  "  NIC Index for Management network is = 2"
echo " NIC Index for Tunnel network is     = 3 "
echo " This can be confirmed by running the command : ifconfig "
